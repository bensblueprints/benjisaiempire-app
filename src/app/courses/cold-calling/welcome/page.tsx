...
export const metadata: Metadata = {
  title: "Welcome — Cold Calling 2.0 + AI | Benji's AI Empire",
...
export default function Page() {
  ...
  .welcome-hero__right::after{
    content:""; position:absolute; inset:0;
    background:linear-gradient(90deg, var(--ink) 0%, transparent 18%, transparent 82%, rgba(11,11,12,.6) 100%);
    pointer-events:none;
  }
  ...
  @media(min-width:900px){
    .welcome-section__head{ grid-template-columns: 1fr 1.2fr; align-items:end; gap:48px; }
  }
  ...
  .welcome-section__eyebrow::after{
    content:""; flex:0 0 56px; height:2px; background:var(--gold);
  }
  .welcome-section__title{
    font-family:'Anton', sans-serif; font-weight:400;
    font-size:clamp(34px, 4vw, 64px);
    line-height:.95; letter-spacing:-.005em;
    text-transform:uppercase; color:var(--cream); margin:8px 0 0;
  }
  ...
  .step__title{
    font-family:'Anton', sans-serif; font-weight:400;
    font-size:clamp(22px, 2.2vw, 30px); line-height:1;
  ...
  .cont-card__copy{
    font-family:'Fraunces', serif; font-size:15px; line-height:1.55;
    color:var(--cream-soft); margin:0 0 18px; flex:1;
  }
  .cont-card__cta{
  ...
  .cont-card__cta::after{
    content:"→"; color:var(--gold); font-family:'Manrope', sans-serif; letter-spacing:0;
  ...
  @media(min-width:900px){
    .cross__inner{ grid-template-columns: 1fr auto; gap:32px; }
  }
  .cross__copy{
    font-family:'Fraunces', serif; font-weight:400; font-style:italic;
    ...
    <div class="welcome-hero__grid">
      <div class="welcome-hero__left">
        ...
        <div>
          ...
          <h1 class="welcome-hero__title">You're in: Cold Calling <span class="accent">2.0 + AI.</span></h1>
          <p class="welcome-hero__lede">
            Course access provisioned. Master Script PDF, the 30-second opener teardown,
            and the AI prep prompts are all unlocked. <em>Here's what to do in the next 24 hours.</em>
          </p>
    ...
    <div class="welcome-section__inner">
      <header class="welcome-section__head">
        ...
        <p class="welcome-section__lede">
          The members who finish module 01 in the first week stay for years. The members who
          bookmark and forget never come back. Don't be the second one.
        </p>
      </header>
      ...
      <div class="steps">
        ...
        <article class="step">
          ...
          <p class="step__copy">
            Posted in the Insider community vault. Master Script PDF, objection-handling prompt
            pack, and the AI prep checklist. Print page one.
          </p>
        </article>
        <article class="step">
          ...
          <p class="step__copy">
            Calendar it. One sitting, no phone, module 01. <em>If it's not on the calendar it
            isn't real.</em> Tuesday Cold Call Live is the second hour.
          </p>
        </article>
      </div>
    </div>
      ...
      <div class="continue-grid">
        ...
        <a class="cont-card" href="/courses/brand-builder/">
          ...
          <p class="cont-card__copy">
            Logo, voice, positioning, deck, site — built in a week with Claude + Cursor + Figma.
            Pair with Cold Calling so the prospect knows who you are.
          </p>
          <span class="cont-card__cta">Open Brand Builder</span>
        </a>

        <a class="cont-card" href="/courses/marketing-engine/">
          <div class="cont-card__kicker"><span>03</span><span class="rule"></span><span>Engine</span></div>
          <h3 class="cont-card__title">AI Marketing Engine</h3>
          <p class="cont-card__copy">
            The funnel, the email sequences, the ads, the retargeting — all wired in GHL with
            AI doing the copy. This is what runs after the cold call hits.
          </p>
          <span class="cont-card__cta">Open Marketing Engine</span>
        </a>
        ...
        <a class="cont-card" href="/courses/empire-os/">
          ...
          <p class="cont-card__copy">
            ...
            Take after the first three start producing.
          </p>
