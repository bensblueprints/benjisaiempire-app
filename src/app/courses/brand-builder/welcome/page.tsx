...
export const metadata: Metadata = {
  title: "Welcome — AI Brand Builder | Benji's AI Empire",
...
export default function Page() {
  ...
  .welcome-hero__left{
    ...
    gap:clamp(40px, 6vw, 80px); z-index:2;
  }
      ...
      <div class="welcome-hero__left">
        ...
        <div>
          ...
          <p class="welcome-hero__lede">
            ...
            and the one-week sprint plan are unlocked. <em>Here's what to do in the next 24 hours.</em>
          </p>
    ...
    <div class="welcome-section__inner">
      <header class="welcome-section__head">
        ...
        <p class="welcome-section__lede">
          Brand work is where most operators stall — they wait for inspiration. The sprint plan in
          module 01 removes that excuse. Run it once, ship it once, move on.
        </p>
      </header>
      ...
      <div class="steps">
        ...
        <article class="step">
          ...
          <p class="step__copy">
            Posted in the Insider community vault. Brand voice doc template, logo-direction prompt
            pack, and the seven-day sprint checklist. Print page one.
          </p>
        </article>
        <article class="step">
          ...
          <p class="step__copy">
            Calendar it. One sitting, no phone, module 01 — the positioning teardown. <em>If it's
            not on the calendar it isn't real.</em>
          </p>
        </article>
      </div>
    </div>
      ...
      <div class="continue-grid">
        ...
        <a class="cont-card" href="/courses/cold-calling/">
          ...
          <p class="cont-card__copy">
            The 30-second opener, the AI prep stack, the Master Script PDF. Once your brand is
            set, this is what fills the calendar.
          </p>
        ...
        <a class="cont-card" href="/courses/marketing-engine/">
          ...
          <p class="cont-card__copy">
            ...
            AI doing the copy. Brand in, leads out.
          </p>
