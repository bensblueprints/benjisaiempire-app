...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Welcome — AI Marketing Engine", description: "Course access provisioned. Here's what to do next.", images: [{ url: "https://benjisaiempire.com/images/course-marketing-engine.jpg?v=3" }], type: "website" }
};
  ...
  <section class="welcome-hero" aria-label="Course welcome hero">
    <div class="welcome-hero__grid">
      ...
      <div class="welcome-hero__right">
        <img class="welcome-hero__photo" src="/images/course-marketing-engine.jpg?v=3" alt="Marketing engine — funnels, sequences, GHL automations" />
