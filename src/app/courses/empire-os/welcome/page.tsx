...
export const metadata: Metadata = {
  title: "Welcome — Empire OS | Benji's AI Empire",
  description: "You're in. Here's the 24-hour playbook for Empire OS.",
  alternates: { canonical: "https://benjisaiempire.com/courses/empire-os/welcome" },
  robots: { index: false, follow: true },
  openGraph: { title: "Welcome — Empire OS", description: "Course access provisioned. Here's what to do next.", images: [{ url: "https://benjisaiempire.com/images/course-empire-os.jpg?v=throne" }], type: "website" }
};
    ...
    <div class="welcome-hero__grid">
      <div class="welcome-hero__left">
        <div class="welcome-hero__rail">
          ...
          <span>Course 04 / 04</span>
          <span class="welcome-hero__check">Access Live</span>
        </div>
        <div>
          <p class="welcome-hero__eyebrow">System Track <span>·</span> AI Empire Insider $9</p>
          <h1 class="welcome-hero__title">You're in: <span class="accent">Empire OS.</span></h1>
          <p class="welcome-hero__lede">
            Course access provisioned. The agency SOP pack, the daily rhythm template, the first-VA
            hiring playbook, and the client onboarding kit are all unlocked. <em>Here's what to do in the next 24 hours.</em>
          </p>
    ...
    <div class="welcome-section__inner">
      <header class="welcome-section__head">
        ...
        <p class="welcome-section__lede">
          This is the course people skip and regret. Operating systems are boring on a Tuesday;
          they're the difference between $20K MRR and $100K MRR by Q4.
        </p>
      </header>
      ...
      <div class="steps">
        ...
        <article class="step">
          ...
          <p class="step__copy">
            Posted in the Insider community vault. The full SOP library, the daily rhythm
            template, and the first-90-days hiring kit. Copy the SOP folder into your Notion.
          </p>
        </article>
        <article class="step">
          ...
          <p class="step__copy">
            Calendar it. One sitting, no phone, module 01 — the daily rhythm walk-through.
            <em>If it's not on the calendar it isn't real.</em>
          </p>
        </article>
      </div>
    </div>
      ...
      <div class="continue-grid">
        ...
        <a class="cont-card" href="/courses/cold-calling/">
          ...
          <p class="cont-card__copy">
            The 30-second opener, the AI prep stack, the Master Script PDF. Empire OS keeps
            you in the chair; cold calling fills it with revenue.
          </p>
        ...
        <a class="cont-card" href="/courses/brand-builder/">
          ...
          <p class="cont-card__copy">
            ...
            Pair with Empire OS and the brand actually ships.
          </p>
        ...
        <a class="cont-card" href="/courses/marketing-engine/">
          ...
          <p class="cont-card__copy">
            ...
            AI doing the copy. The engine your OS runs on top of.
          </p>
