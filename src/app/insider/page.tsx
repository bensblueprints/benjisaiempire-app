    ...
    <div class="ins-wrap">
      ...
      <div class="ins-hero__grid">
        ...
        <figure class="ins-hero__photo" aria-hidden="false">
          <img src="/images/course-marketing-engine.jpg?v=3" alt="Streaming rig where Benji ships build days every Thursday" loading="eager" decoding="async" />
      ...
      <div class="ins-bucket__grid" role="list">
        ...
        <article class="ins-tile ins-tile--photo ins-tile--wide" role="listitem" aria-labelledby="tile-01-t">
          <div class="ins-tile__photo-wrap">
            <img src="/images/course-cold-calling.jpg?v=3" alt="Cold Calling 2.0 + AI course thumbnail" loading="lazy" decoding="async" />
        ...
        <article class="ins-tile ins-tile--photo" role="listitem" aria-labelledby="tile-02-t">
          <div class="ins-tile__photo-wrap">
            <img src="/images/course-brand-builder.jpg?v=3" alt="AI Brand Builder course thumbnail" loading="lazy" decoding="async" />
            <div class="ins-tile__photo-overlay">
        ...
        <article class="ins-tile ins-tile--photo" role="listitem" aria-labelledby="tile-03-t">
          <div class="ins-tile__photo-wrap">
            <img src="/images/course-marketing-engine.jpg?v=3" alt="AI Marketing Engine course thumbnail" loading="lazy" decoding="async" />
            <div class="ins-tile__photo-overlay">
