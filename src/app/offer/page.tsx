...
import JarvisBox from "@/components/JarvisBox";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://benjisaiempire.com/offer" },
  openGraph: { title: "Benji's AI Empire", description: "Sales call videos free. $10 for everything else. $49 wholesale GHL — first 100.", url: "https://benjisaiempire.com/offer", images: [{ url: "https://benjisaiempire.com/images/hero-empire.jpg?v=2" }], type: "website" }
};

export default function Page() {
  return (
    <>
      <Suspense fallback={null}><UnlockBanner /></Suspense>
