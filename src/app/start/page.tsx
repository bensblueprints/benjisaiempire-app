...
export const metadata: Metadata = {
  title: "Free Business Plans — Benji's AI Empire",
  description:
    "Drop your email and get my entire library of done-for-you business plans free — the exact breakdowns from my daily videos. New plans added every week.",
  alternates: { canonical: "https://benjisaiempire.com/start" },
  openGraph: {
    ...
    url: "https://benjisaiempire.com/start",
  ...
  .foot a{color:var(--gold)}
      ...
      <main className="bridge">
        <div className="bridge-inner">
          <div className="wordmark">Benji&apos;s AI Empire</div>
          ...
          <p className="foot">
            Want everything? <a href="/">See what&apos;s inside the Empire →</a>
          </p>
        </div>
      </main>
    </>
